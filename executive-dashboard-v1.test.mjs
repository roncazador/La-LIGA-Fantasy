...
assert.ok(ui.includes("return'APLAZADO'"), 'postponed status must render as APLAZADO');
assert.ok(ui.includes("return'CANCELADO'"), 'cancelled status must render as CANCELADO');
