...
## Interfaz
La interfaz mantiene las mismas secciones y flujos. El ajuste visual actual refina únicamente jerarquía, espaciado, contraste, foco accesible y disposición para iPhone horizontal, reduciendo la altura de navegación y compactando KPI cuando la pantalla tiene poca altura.
