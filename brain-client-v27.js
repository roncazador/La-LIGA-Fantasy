(() => {
  ...
  function mount(status){
    ...
    if(!panel){
      ...
      panel.id='brain27Panel';
      panel.className='of213-card';
      view.prepend(panel);
    }
    ...
    panel.innerHTML=`
      <div style="display:flex;justify-content:space-between;gap:10px;align-items:flex-start;flex-wrap:wrap">
        ...
        <div class="of213-muted">Aprendizaje automático basado en observaciones y resultados reales. El modelo cambia sus propios pesos.</div></div>
      ...
      <div class="of213-g4" style="margin-top:10px">
        ...
        <div class="of213-card of213-metric"><div class="of213-label">Precisión direccional</div><div class="of213-value">${pct(status.accuracy)}</div></div>
      ...
      <div class="of213-note">Fuente de aprendizaje: <b>${esc(status.sourcePolicy)}</b>. El calendario visible continúa usando únicamente LALIGA oficial; las fuentes auxiliares solo aportan señales de entrenamiento y no aparecen como proveedor del calendario.</div>
    `;
