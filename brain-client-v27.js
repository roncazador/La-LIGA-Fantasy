  ...
  function mount(status){
    ...
    panel.innerHTML=`
      <div style="display:flex;justify-content:space-between;gap:10px;align-items:flex-start;flex-wrap:wrap">
        ...
        <div class="of213-muted">Aprende de observaciones y resultados reales. Reajusta sus propios pesos, vigila su deriva y conserva memoria histórica por jugador.</div></div>
