...
assert.equal(checks.length,25);for(const[i,[name,ok]]of checks.entries())assert.ok(ok,`DEPLOY28-${String(i+1).padStart(3,'0')}: ${name}`);console.log('DEPLOYMENT CONTRACT v5.5: 25/25 checks passed');
