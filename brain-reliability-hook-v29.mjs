...
const INSTALL_KEY = Symbol.for('laliga.brain.reliabilityHook.v29');
...
if (!globalThis[INSTALL_KEY]) {
  ...
  BrainV27.prototype.predict = function predictWithReliability(player, context = {}) {
    ...
    return { ...prediction, confidence: reliability.displayedConfidence, rawConfidence, reliability, reliabilityVersion: RELIABILITY_VERSION };
  };
