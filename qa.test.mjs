...
const standingFixture={rank:1,team:{id:529,name:'FC Barcelona'},points:6,all:{played:2,win:2,draw:0,lose:0,goals:{for:5,against:1}}};
const standings=normalizeStandings({response:[{league:{standings:[[standingFixture]]}}]});
