...
assert.deepEqual(activeCalendar,["loadInline('/calendar-autonomous-v35.js'"]);
...
console.log('CALENDAR STACK INTEGRITY v1: one active calendar, one interaction core, one identity bridge, legacy detail loaders disabled');
