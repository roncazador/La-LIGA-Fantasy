...
for(const pattern of ["loadInline('/automation-hub-v1.js','1')","loadInline('/executive-dashboard-v1.js','1')","loadInline('/evidence-isolation-v1.js','1')","loadInline('/app-dynamics-v37.js','37')","loadInline('/calendar-autonomous-v35.js','35')","loadInline('/focus-ui-v30.js','30')","loadInline('/futbolfantasy-ui-v30.js','30')","loadInline('/match-detail-ui-v31.js','33')","loadInline('/match-center-ui-v1.js','1')"])assert.ok(connection.includes(pattern),`loader must use inline-safe path: ${pattern}`);
