...
const publicAssets=['/app-dynamics-v37.js','/calendar-autonomous-v35.js','/match-detail-ui-v31.js','/focus-ui-v30.js','/futbolfantasy-ui-v30.js','/automation-hub-v1.js','/match-center-ui-v1.js'];
...
for(const pattern of ["loadInline('/automation-hub-v1.js','1')","loadInline('/executive-dashboard-v1.js','1')","loadInline('/evidence-isolation-v1.js','1')","loadInline('/app-dynamics-v37.js','37')","loadInline('/calendar-autonomous-v35.js','35')","loadInline('/focus-ui-v30.js','30')","loadInline('/futbolfantasy-ui-v30.js','30')","loadInline('/calendar-focus-v1.js'","loadInline('/calendar-focus-fix-v1.js'","loadInline('/match-center-ui-v1.js','1')"])assert.ok(connection.includes(pattern),`loader must use inline-safe path: ${pattern}`);
assert.ok(!connection.includes("loadInline('/match-detail-ui-v31.js','33')"),'legacy match detail must not be actively loaded');
...
console.log(`STATIC ASSETS CONTRACT v1: ${loadedAssets.length} loader assets · fallback J3/J4 complete · legacy detail inactive`);
